...
Game_Interpreter.prototype.setup = async function(list, eventId) {
    this.clear();
...
Game_Interpreter.prototype.command118 = function() {
    EventManager.setLabel(this._params[0])
    return true;
};
...
Game_Interpreter.prototype.command126 = function() {
    ...
    if (value > 0){
        EventManager.startLogText("Get Item : " +$dataItems[this._params[0]].name+ " x" + value);
    }
    return true;
};
...
Game_Interpreter.prototype.command127 = function() {
    ...
    if (value > 0){
        EventManager.startLogText("Get Weapon : " +$dataWeapons[this._params[0]].name+ " x" + value);
    }
    return true;
};
...
Game_Interpreter.prototype.command128 = function() {
    ...
    if (value > 0){
        EventManager.startLogText("Get Armor : " +$dataArmors[this._params[0]].name+ " x" + value);
    }
    return true;
};
...
Game_Interpreter.prototype.command212 = function() {
    EventManager.showAnimation(this._params[1]);
    return true;
};

// Show Balloon Icon
Game_Interpreter.prototype.command213 = function() {
    EventManager.setPictureEmotion(this._params[1])
    return true;
};
...
Game_Interpreter.prototype.command221 = function() {
    EventManager.startFadeOut(this.fadeSpeed());
...
Game_Interpreter.prototype.command222 = function() {
    EventManager.startFadeIn(this.fadeSpeed());
    this.wait(this.fadeSpeed());
    this._index++;
    return false;
};
...
Game_Interpreter.prototype.command223 = function() {
    ...
    BackGroundManager.startTint(this._params[0], this._params[1]);
    if (this._params[2]) {
...
Game_Interpreter.prototype.command224 = function() {
    EventManager.startFlash(this._params[0], this._params[1]);
    if (this._params[2]) {
        this.wait(this._params[1]);
    }
    return true;
...
Game_Interpreter.prototype.command231 = function() {
    ...
    EventManager.showPicture(this._params[1],this._params[1],x,y,this._params[0],this._params[6],this._params[7],this._params[8],this._params[9]);
    return true;
};
...
Game_Interpreter.prototype.command232 = function() {
    ...
    EventManager.movePicture(x, y,this._params[0], this._params[6]/100,this._params[7]/100, this._params[8],this._params[10]/60)
    if (this._params[11]) {
...
Game_Interpreter.prototype.command234 = function() {
    EventManager.tintPicture(this._params[1]);
    if (this._params[3]) {
        this.wait(this._params[2]);
    }
    return true;
...
Game_Interpreter.prototype.command283 = function() {
    BackGroundManager.changeBackGround(this._params[0], this._params[1]);
...
Game_Interpreter.prototype.command301 = function() {
    ...
    if (this._params[0] === 0) {  // Direct designation
        ...
        $gameParty.stageEvent()._eventId = troop;
