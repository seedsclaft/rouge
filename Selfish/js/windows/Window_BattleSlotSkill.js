//-----------------------------------------------------------------------------
// Window_BattleSlotSkill
//

class Window_BattleSlotSkill extends Window_SkillBase{
    ...
    selectLast(){
        let index = 0;
        if (index >= 0){
            this._skillList.forceSelect(index);
        }
        this._skillList.selectLast();
        this._skillList.refresh();
    }

    selectLastOther(index){
        this._skillList.forceSelect(index);
        this._skillList.selectLast();
        this._skillList.refresh();
    }
    ...
    setData(data,actor){
        this._actor = actor;
        this._skillList.setDataOnly(data);
        this.selectLast();
        this.refresh();
    }
